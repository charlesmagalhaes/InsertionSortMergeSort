...
public class AplicacaoSort {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Tempo de processamento por insertion Sort: %.7f ms%n", (tempoFinal1 - tempoInicial1) / 1000d);
		...
		System.out.printf("Tempo de processamento por Merge Sort: %.7f ms%n", (tempoFinal1 -
		tempoInicial1) / 1000d);
